...
public class DanceController : MonoBehaviour
{
    ...
    public IEnumerator ResetDance()
    {
        ...
        float failAnimationLengh = _characterAnimator.runtimeAnimatorController.animationClips.First(clip => clip.name == _failAnimationName).length;
        yield return new WaitForSeconds(failAnimationLengh);
        _characterAnimator.Play(_currentSoundData.animationName);
